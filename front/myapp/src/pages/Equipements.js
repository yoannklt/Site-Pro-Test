    ...
    return (
        <div className="fond">
            ...
            <div className="class">
                ...
                <div className="row Bob" id="ekip">
                   <div className ="col-lg-5 img text-center">
                        <img className="img-fluid img146 align-self-center" src={image121} alt="img121"></img>
                   </div>
                ...
                <div className="col-lg-12 align-text-center txtesE">
                ...
                <div className="troiscase">
                    <div className="row ekip1">
                        <div className="container col-lg-5 img text-center ">
                            <img className="img-fluid btob2 align-self-center" src={ekip1} alt="img8" />
                        </div>
                        <div className="col-lg-7 text-left align-self-center txt">
                            <h3><strong>CASQUE HTC MASQUE</strong></h3>
                    ...
                    <div className="row ekip2">
                        ...
                        <div className="container col-lg-5 img text-center">    
                            <img className="img-fluid btob1 align-self-center" src={ekip2} alt="image25" />
                        </div>
                    </div>
                    <div className="row ekip3">
                        <div className="container col-lg-5 img text-center">
                            <img className="img-fluid btob3 align-self-center" src={ekip3} alt="img8" />
                        </div>
                        <div className="col-lg-7 text-left align-self-center txt">
